...
const CoursesSection = () => {
  ...
  return (
    <div className="py-16 px-8 md:px-40">
      <h2 className="text-gray-800 font-medium text-3xl">Learn from the best</h2>
      ...
      className="text-gray-800 border border-gray-500/30 px-10 py-3 rounded hover:shadow-md  ">Show all courses
      </Link>
    </div>
    );
};
